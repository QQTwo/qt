		...
		function renderDate(data,curr){
			...
			if(currData.length != 0){
				for(var i=0;i<currData.length;i++){
			    	...
			    	+'<td>'+currData[i].linksName+'<input type="text" name="catname[4]" id="catname4" value="微整形" class="validate[required]" style="display:none" /></td>'
			    	+'<td>--<input name="sort[4]" type="text" class="validate[required,custom[integer],min[0],max[255]]" id="sort4" value="'+currData[i].linksId+'" size="8" /></td>'
			    	+'<td>显示</td>'
			    	+'<td>'
